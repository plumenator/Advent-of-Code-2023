...
mod test {
    #[test]
    fn part1_example() {
        assert_eq!(super::part1("src/day6_test_input.txt"), 288)
    }
    #[test]
    fn part1_actual() {
        assert_eq!(super::part1("src/day6_input.txt"), 633080)
    }
    #[test]
    fn part2_example() {
        assert_eq!(super::part2("src/day6_test_input.txt"), 71503)
    }
    #[test]
    fn part2_actual() {
        assert_eq!(super::part2("src/day6_input.txt"), 20048741)
    }
}
